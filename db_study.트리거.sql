...
-- 트리거 subquery_study.board_mst_after_insert 구조 내보내기
DROP TRIGGER IF EXISTS `board_mst_after_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `board_mst_after_insert` AFTER INSERT ON `board_mst` FOR EACH ROW BEGIN
		INSERT into
		user_dtl
		(id)
		VALUES
