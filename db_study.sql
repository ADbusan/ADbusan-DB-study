...
INSERT INTO `product_mst` (`id`, `product_name`, `product_price`) VALUES
	...
	(6, '스타벅스 블루 머그컵', '25000'),
	(7, '스타벅스 블랙 머그컵3', '15000'),
	(8, '스타벅스 화이트 머그컵3', '20000'),
	(9, '스타벅스 블루 머그컵3', '25000'),
	(10, '스타벅스 블랙 머그컵4', '15000'),
	(11, '스타벅스 화이트 머그컵4', '20000'),
	(12, '스타벅스 블루 머그컵4', '25000');

-- 테이블 db_study.student1_mst 구조 내보내기
DROP TABLE IF EXISTS `student1_mst`;
CREATE TABLE IF NOT EXISTS `student1_mst` (
  `id1` int NOT NULL AUTO_INCREMENT,
  `student_year1` int NOT NULL DEFAULT '0',
  `score1` int NOT NULL DEFAULT '0',
  `student_name1` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id1`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- 테이블 데이터 db_study.student1_mst:~0 rows (대략적) 내보내기
DELETE FROM `student1_mst`;
INSERT INTO `student1_mst` (`id1`, `student_year1`, `score1`, `student_name1`) VALUES
	(4, 20, 50, '장근영'),
	(5, 30, 70, '조광현'),
	(6, 45, 90, '서정현'),
	(7, 20, 50, '장근영'),
...
CREATE TABLE IF NOT EXISTS `user_mst` (
  ...
  `텀블러를 산 년도` year DEFAULT NULL,
  `텀블러를 산 날짜 시간` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user_mst` (`id`, `username`, `password`, `텀블러를 산 년도`, `텀블러를 산 날짜 시간`) VALUES
	(1, 'aaa', '123', '2022', '2022-12-06 00:00:00'),
	(2, 'bbb', '123', '2022', '2022-12-06 00:00:00'),
	(3, 'ccc', '123', '2022', '2022-12-06 00:00:00'),
	(4, 'ddd', '123', '2022', '2022-12-06 00:00:00');
